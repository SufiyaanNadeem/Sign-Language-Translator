...
export declare type TensorContainerAny = void | Tensor | string | number | boolean | TensorContainerObject | TensorContainerArray;
...
export declare type TensorContainer = TensorContainerAny | Promise<TensorContainerAny>;
